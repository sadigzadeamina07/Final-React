 ...
 <div className='max-w-[1300px] py-[24px] mx-auto '>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6">
          <div className="text-center flex flex-col items-center">
            <img src="/assets/img/Footer/bus.png" className='w-[100px]' alt="" />
            <h3 className='font-semibold'>Free Delivery & Returns</h3>
            <p>on all orders over $50</p>
          </div>
          <div className="text-center flex flex-col items-center">
            <img src="/assets/img/Footer/Cards.png" className='w-[100px]' alt="" />
            <h3 className='font-semibold'>Get 2 free samples </h3>
            <p>with all orders</p>
          </div>
          <div className="text-center flex flex-col items-center">
            <img src="/assets/img/Footer/Lips.png" className='w-[120px]' alt="" />
            <h3 className='font-semibold'>Free Delivery & Returns</h3>
            <p>on all orders over $50</p>
          </div>
        </div>
  ...
  <h3 className='uppercase font-bold'>Support</h3>
      ...
      <div className='flex flex-col gap-2'>    
        <h3 className='uppercase font-bold'>SIGN UP TO RECEIVE EMAILS</h3>
