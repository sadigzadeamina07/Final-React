    ...
    <div className='text-[#340c0c]' >
      ...
      <div className="bg-white p-[1rem] ">
        ...
        <div className="container max-w-[1300px] mx-auto">
          <div className="hidden  md:flex h-[10vh]  justify-center items-center ">
        
         <ul className='flex  font-semibold gap-5 uppercase'>
          <li className='text-[#a06464]'><Link to='/' >Up to a magical 20% off</Link></li>
          ...
          <li><Link to='/' >SHADE MATCH TOOLS</Link></li>
